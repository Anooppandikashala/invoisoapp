...
var testimonials = [
  ...
  },
  {
    name: 'Sanchit Kumar',
    location: '',
    text: 'Really a fantastic free invoice software for small business',
    stars: 5,
  },
  {
    name: 'Aaron A.',
...
function initScreenshots() {
  var screenshots = [
    ...
    { src: 'customize_product_details.png',      text: 'Customize Product Fields',      alt: 'Customize product details in Invoiso \u2014 toggle which fields show on product forms, list and invoice line items',   category: 'Products' },
    ...
    { src: 'accessibility_screen.png',           text: 'Accessibility Settings',        alt: 'Accessibility settings in Invoiso \u2014 choose invoice page layout and view keyboard shortcuts for faster invoicing', category: 'Settings' },
